...
function testIntersectSchema(intersectSchema) {
  ...
  describe('for properties', () => {
    ...
    it('throws TypeError for non-object properties', () => {
      assert.throws(
        () => {
          intersectSchema(
    ...
    it('throws TypeError for non-object patternProperties', () => {
      assert.throws(
        () => {
          intersectSchema(
    ...
    it('throws TypeError for non-object additionalProperties', () => {
      assert.throws(
        () => {
          intersectSchema(
  ...
  describe('for dependentRequired', () => {
    ...
    it('throws TypeError for non-Array property', () => {
      assert.throws(
        () => {
          intersectSchema(
